...
function MainPage() {
  return (
    <div className=" h-[100vh] sm:h-[80vh] bg-[#f2f4f7] sm:flex sm:flex-wrap   ">
      <div className=" h-[40%] p-4 sm:h-full sm:flex-1 sm:flex sm:justify-end">
        <div className="flex flex-col items-center  p-4 gap-y-32 sm:gap-y-0 sm:justify-center  h-full ">
          <div className="language text-[19px]w-full ">
            ...
            <p className="hidden sm:flex  sm:text-[80px] sm:font-semibold sm:text-[#125cef] sm:items-start">
              facebook
            </p>
          </div>
          <div>
            ...
            />
            <p className="hidden sm:flex sm:flex-col sm:text-[28px] text-black">
      ...
      <div className=" w-full h-[60%]   sm:h-full sm:flex-1 pt-4  px-4  flex flex-col justify-around sm:flex-row sm:items-center sm:justify-center sm:p-10 ">
        <div className="  w-full h-full sm:flex sm:items-center sm:justify-start sm:px-10" >
          <form action="" className="w-full flex flex-col   gap-y-4 sm:gap-y-5 sm:w-[500px] sm:px-8 sm:pt-6 sm:pb-14 sm:border-2 sm:bg-white sm:rounded-2xl">
            <input
