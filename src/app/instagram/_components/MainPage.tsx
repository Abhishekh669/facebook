    ...
    <div className=" h-[100vh] w-[100vw] sm:h-[80vh] bg-[#f2f4f7] sm:flex sm:flex-row ">
      ...
      <div className=" w-full h-[60%]   sm:h-full sm:flex-1 pt-4  px-4  flex flex-col justify-around sm:flex-row sm:items-center sm:justify-center sm:p-0 lg:p-[20px] ">
        <div className="  w-full h-full sm:flex sm:items-center sm:justify-start lg:px-10" >
          <form action="" className=" form-login  w-full flex flex-col sm:shadow-custom-login sm:border-none sm:border-box  gap-y-4 sm:gap-y-5 sm:w-[250px] md:w-[450px]  sm:px-8 sm:pt-6 sm:pb-14 sm:border-2 sm:bg-white sm:rounded-2xl">
            <p>
              <Image  width={400} height={400} src='/instlogo.png' alt='' className="h-[100px] w-[100px] "/>
            </p>
            <input
              placeholder="Mobile number or email "
              className="  border-[0.4px] p-[16px] text-black sm:p-[16px] border-gray-400 placeholder:text-gray-500 placeholder:text-[14px] sm:placeholder:text-[20px] rounded-xl focus:outline-[1px] focus:outline-blue-500 sm:rounded-sm"
            />
            <input
              placeholder="Password"
              className="border-[1px] text-black p-[16px] sm:p-[16px] border-gray-400 placeholder:text-gray-500 placeholder:text-[14px]  sm:placeholder:text-[20px] rounded-xl sm:rounded-none"
            />
